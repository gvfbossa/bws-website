...
export class PortfolioService {
  private projects = [
    ...
    {
      title: 'Site Fácil Já',
      description: 'Sites Profissionais para sua empresa, produtos, serviços, portfólio e landing page.',
      images: ['assets/images/portfolio-sitefacilja1.png'],
      url: 'https://sitefacilja.bossawebsolutions.com.br/',
    },
    /** 
    {
      title: 'Loja Virtual',
